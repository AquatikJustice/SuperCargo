...
// each column stacks all the way UP before the next one starts across. Narrow
// (unrotated) orientation is tried first, keeping boxes tight against the wall
// instead of reaching out toward the aisle.
function findSpot(
  s: Bay,
  w: number,
  l: number,
